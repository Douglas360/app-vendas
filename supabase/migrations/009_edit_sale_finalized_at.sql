-- ============================================================
-- Edição de venda re-carimba finalized_at (data de faturamento)
-- Assim, ao editar uma venda antiga, ela conta no faturamento do
-- dia da edição (o dashboard usa finalized_at).
-- ============================================================
